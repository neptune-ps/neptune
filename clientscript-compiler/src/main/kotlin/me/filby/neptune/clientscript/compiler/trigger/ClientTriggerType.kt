...
enum class ClientTriggerType(
    ...
    UPDATEOBJSTACK(45, pointers = EnumSet.of(PointerType.ACTIVE_TILE)),
    ...
    ONCLICKLOC(78, pointers = EnumSet.of(PointerType.ACTIVE_LOC)),
    ONCLICKOBJ(79, pointers = EnumSet.of(PointerType.ACTIVE_OBJ)),
    ONCLICKNPC(80, pointers = EnumSet.of(PointerType.ACTIVE_NPC)),
    ONCLICKPLAYER(81, pointers = EnumSet.of(PointerType.ACTIVE_PLAYER)),
    TRIGGER_82(82),
